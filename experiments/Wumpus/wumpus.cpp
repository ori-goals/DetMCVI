...
void runMCVI(Wumpus* pomdp, const BeliefStates& init_belief,
...
void runAOStar(Wumpus* pomdp, const BeliefStates& init_belief,
...
void runQMDP(Wumpus* pomdp, const BeliefStates& init_belief,
...
int main(int argc, char* argv[]) {
  ...
  {  // Run MCVI
    auto mcvi = Wumpus(grid_size, heuristic_samples, rng);
  ...
  {  // Compare to AO*
    auto aostar = Wumpus(grid_size, heuristic_samples, rng);
  ...
  {  // QMDP
    auto qmdp = Wumpus(grid_size, heuristic_samples, rng);
